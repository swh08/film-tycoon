...
const SVG_ICONS: Record<string, () => React.ReactNode> = {
  ...
  globe: () => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      {/* 大陆 */}
      {/* 非洲（中间偏右，三角形轮廓） */}
      <path d="M12 5.5Q13.5 5.5 14 7L14.5 9Q14.5 10 14 11.5Q13.5 13.5 13 15Q12.5 17 11.5 17.5Q10.5 17.5 10.5 15.5Q10.5 13 10.5 11.5Q10.5 9 11 7Q11.5 5.5 12 5.5Z" fill="#4ADE80" />
      {/* 欧洲（非洲上方，不规则小块） */}
      <path d="M10 5Q11 4.5 13 4.5Q14.5 5 14.5 6L14 7.5Q13 7.5 11.5 7Q10 7 9.5 6Q9 5.5 10 5Z" fill="#4ADE80" />
      {/* 亚洲（右上大片） */}
      <path d="M14.5 4.5Q16.5 4 18 5.5Q19 7 18.5 9Q18 10.5 17 11Q15.5 11.5 14.5 10.5L14 7.5L14.5 4.5Z" fill="#4ADE80" />
      {/* 南美洲（左侧，倒三角） */}
      <path d="M7 8Q8 7 8.5 8.5Q9 10 8.5 12.5Q8 14.5 7.5 16Q7 17 6 16.5Q5.5 15 5.5 13Q5.5 10.5 6 9Q6.5 7.5 7 8Z" fill="#4ADE80" />
      {/* 北美洲（左上方块） */}
      <path d="M4 5.5Q5.5 4.5 7 5Q8.5 5.5 9 6.5Q9 7.5 8 8Q6.5 8 5.5 7Q4.5 6.5 4 5.5Z" fill="#4ADE80" />
      {/* 经纬线 */}
